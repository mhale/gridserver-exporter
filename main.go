...
var (
	...
	tlsVerify     = kingpin.Flag("tls-verify", "Enable (or disable with --no-tls-verify) TLS certificate verification for the Web Services URL. Enabled by default.").Default("true").Envar("GRIDSERVER_EXPORTER_TLS_VERIFY").Bool()
